  ...
  return (
    ...
    >
      <div className="grid gap-5 md:grid-cols-2">
        ...
        <TextField name="location" label="Location" placeholder="Bengaluru, India" defaultValue={job?.location} required />
      ...
      <ChipInput
        ...
        hint="Add at least one skill. These drive candidate match scores."
        values={skills}
        onChange={setSkills}
      />
      <ChipInput label="Preferred skills" hint="Optional nice-to-have skills." values={preferred} onChange={setPreferred} />
      <TextAreaField
        name="description"
        label="Description"
        rows={6}
